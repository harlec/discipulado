            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <div class="space-y-3">
                            <a href="<?= SITE_URL ?>/modules/asistencia/?curso_id=<?= $id ?>"
                            ...
                            <a href="<?= SITE_URL ?>/modules/calificaciones/?curso_id=<?= $id ?>"
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-6">
                        ...
                        <?php if (hasRole([1])): ?>
                        <a href="clases.php?curso_id=<?= $id ?>" class="text-sm text-blue-600 hover:underline mt-2 inline-block">
                            Generar clases
                        </a>
                        <?php endif; ?>
                        <?php else: ?>
